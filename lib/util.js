...
module.exports = {
  ...
  createCorrespondingDialectEntryFile: function createCorrespondingDialectEntryFile(conceptFilePath) {

  },

  createCorrespondingQueryFile: function createCorrespondingQueryFile(dialectEntryFilePath) {
